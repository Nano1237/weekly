...
export const items: Item[] = [
    ...
    {text: 'Falkner für einen Tag sein', emoji: '🦅', order: 85, dont: true},
    {text: 'Flyboarden', emoji: '💧', dont: true, order: 88},
    {text: 'Eine Molekularküche besuchen', emoji: '⚛️', order: 70, dont: true},
    {text: 'Reiten', emoji: '🏇', order: 75, dont: true},
    {text: 'Einen Tesla probefahren', emoji: '🚘', order: 78, dont: true},
    // DONE
    ...
    {text: 'Ein Kartenhaus bauen', emoji: '🃏', order: 36, done: true},
    // TO DO
    ...
    {text: 'Floating', emoji: '💧', order: 66, dont: true},
    ...
    {text: 'Windsurfing', emoji: '🏄', order: 89},
    {text: 'Höhlentrekking', emoji: '🥾', order: 90},
    {text: 'Ein Ritteressen besuchen', emoji: '🛡️', order: 91},
    {text: 'Mit Milo nach Sankt Peter-Ording fahren', emoji: '🐶', order: 92},
];
